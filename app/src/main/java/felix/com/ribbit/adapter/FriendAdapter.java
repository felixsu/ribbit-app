 ...
 */
public class FriendAdapter extends SingleSelectableAdapter<FriendWrapper, FriendViewHolder> {

    public FriendAdapter(Context context, @NonNull List<FriendWrapper> items) {
        super(context, items);
    }
    ...
    public FriendViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new FriendViewHolder(view, mItemClickListener, mItemLongClickListener, mContext);
    }
}
